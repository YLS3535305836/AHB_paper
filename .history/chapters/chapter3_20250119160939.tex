...
\begin{figure}[htbp]
    \ContinuedFloat
	\centering 
    \subcaptionbox{两个目标打架\label{fig:feature_analysis_fight_two_targets}}{\includegraphics[width = 0.8\linewidth]{imgs/PointCNN-BiLSTM-window_step_performance.pdf}}
	\caption{逐帧点云和目标点特征折线图}
	\label{fig:Point Cloud  And Target Feature Analysis Over Frames}
\end{figure}
