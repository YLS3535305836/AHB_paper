...
\begin{figure}[htbp]
	\centering
	\subcaptionbox{PointCNN-BiLSTM实验结果\label{fig:PointCNN-BiLSTM-window_step_performance}}{\includegraphics[width = 0.5\linewidth]{imgs/PointCNN-BiLSTM-window_step_performance.pdf}}
	\subcaptionbox{PointNet++-BiLSTM实验结果\label{fig:PointNet++-BiLSTM-window_step_performance}}{\includegraphics[width = 0.5\linewidth]{imgs/PointNet++-BiLSTM-window_step_performance.pdf}}
\end{figure}

\begin{figure}[htbp]
	\centering
	\subcaptionbox{PointCNN-BiLSTM实验结果\label{fig:PointCNN-BiLSTM-window_step_performance}}{\includegraphics[width = 0.5\linewidth]{imgs/PointCNN-BiLSTM-window_step_performance.pdf}}
	\subcaptionbox{PointNet++-BiLSTM实验结果\label{fig:SpiderCNN-BiLSTM-window_step_performance}}{\includegraphics[width = 0.5\linewidth]{imgs/SpiderCNN-BiLSTM-window_step_performance.pdf}}
\end{figure}
