...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
        \toprule
        窗口大小 $W$ & 步长 $S$ & 准确率 (\%) & F1分数 & 精确度 & 召回率 \\
        \midrule
        10 & 5 & 85.2 & 0.84 & 0.83 & 0.85 \\ % 基线
        10 & 10 & 86.5 & 0.85 & 0.84 & 0.87 \\
        10 & 15 & 84.0 & 0.82 & 0.81 & 0.83 \\
        15 & 5 & 88.6 & 0.87 & 0.86 & 0.89 \\
        15 & 10 & 89.0 & 0.88 & 0.87 & 0.90 \\
        15 & 15 & 87.5 & 0.86 & 0.85 & 0.88 \\
        20 & 5 & 90.1 & 0.89 & 0.88 & 0.91 \\
        20 & 10 & 91.3 & 0.90 & 0.89 & 0.92 \\
        20 & 15 & 89.8 & 0.88 & 0.87 & 0.90 \\
        \bottomrule
    \end{tabular}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.8\linewidth]{imgs/window_step_performance.pdf}
%     \caption{不同窗口大小和步长对模型准确率的影响}
%     \label{fig:window_step_performance}
% \end{figure}
