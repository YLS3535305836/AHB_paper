...
实验结果表明不同融合策略对模型性能具有显著影响。在PointNet-BiLSTM架构中，乘性融合与注意力融合的组合取得最优F1分数0.9444，较单一融合策略提升约1.5-2.3个百分点。值得注意的是，注意力机制在多数模型中展现出关键作用，如PointCNN-BiLSTM单独使用注意力融合时F1分数达0.9608，表明其能有效捕捉跨模态特征关联。
